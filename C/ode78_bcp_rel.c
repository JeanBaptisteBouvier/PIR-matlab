/*=========================================================================
 * ode78_bcp_rel.c mex file to generate
        ...
        int nrhs, const mxArray *prhs[] )
{
    ...
    //---------------------------------------------------------------------
    if(nrhs!=7) {
        mexErrMsgIdAndTxt("custom:ode78_bcp_rel:nrhs","7 inputs required.");
    }
    if(!(nlhs == 2 || nlhs == 4)) {
    ...
    // 3. int    nvar = 12 or 48, the number of state variables
    ...
    if(nlhs == 2)
    {
        ode78_bcp_rel(&t, y, y0, t0, tf, nvar, params);
    }
    else if(nlhs == 4)
    {
        //-----------------------------------------------------------------
    ...
    //if(nlhs == 4) ode78_bcp_vec_rel(&t, y, tv, yv, nGrid, y0, t0, tf, nvar, params);
