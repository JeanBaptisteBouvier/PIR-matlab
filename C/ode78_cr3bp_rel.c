        ...
        int nrhs, const mxArray *prhs[])
{
    ...
    // 1. [t0, tf] the time span
    // 2. double y0[12 or 48], the relative state without or with the STM
    // 3. double mu, the cr3bp mass ratio
    //---------------------------------------------------------------------
    ...
    if(nvar!=12 && nvar!=48)
    {
        mexErrMsgIdAndTxt("custom:ode78_bcp:nts","The state vector (second input) must be of size either 12 or 48.");
    }
    ...
    if(nlhs == 2)
    {
        ode78_cr3bp_rel(&t, y, y0, t0, tf, nvar, &mu); // @TODO - in ode78_rel.c
    }
    else if(nlhs == 4)
    {
        //-----------------------------------------------------------------
        ...
        do{   
            ...
            // Integration
            //-------------------------------------------------------------
            nV = ode78_cr3bp_vec_var_rel(&t, y, tv, yv, nGrid, y0, t0, tf, nvar, &mu); // @TODO - in ode78_rel.c
