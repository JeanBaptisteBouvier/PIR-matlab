function [fg, Lam,Lam_t, it, err] = Continuation(TOF, TOF_cont, int_time, r_syn, v_syn, r_next, tt, nro_T, intervals, phi0, toll, options, it_max, cr3bp)
...
while TOF_current < TOF
      [fg_temp, Lam_temp, Lam_t, it_temp, err_temp] = Lambert_cycle(x_LR_syn, r_next, state_time(tt,nro_T), phi0, TOF_current, toll, it_max, cr3bp, options,tt);
