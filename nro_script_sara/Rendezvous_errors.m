function output = Rendezvous_errors(choice, hold_points_dim, TOF_dim, init_cond, orbits, settings, continuation, plot_yes, primary)
...
for i = 1:np-1
    ...
    pop = Terminator_errors(choice, LVLH, SYN, times_lin, times_cont, settings, nro_T, phi0, n_transf, primary);
    sol{i} = pop;
end
