...
% If primary = 1 it will be choosen the ECI (the primary is the Earth)
...
theta_C_p2 = 0.01*pi/180 :step: d_theta(1);
...
for k = 1:p
  for i = 1:n
    ...
    output_ch = Rendezvous_errors(choice, hold_points_dim, TOF_dim, init_cond, orbits, settings, continuation, 0, primary);
