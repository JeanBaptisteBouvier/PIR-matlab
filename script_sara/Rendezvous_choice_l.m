function output = Rendezvous_choice_l (choice, hold_points_dim, TOF_dim, init_cond, orbits, settings, continuation, plot_yes)
...
if plot_yes == 1
   for i = 1:np-1
      ...
      %plot_1   %linear models
       plot_3_choice_l(choice, choice_help, sol_plot, Lam_plot, Lam_plot_t, r_f_syn, r_f , np, cr3bp, nro_T, nro_C, x0_T, x0_C, i, t_f,t_C, fg_plot, err_plot)  %Lambert
   end
end
