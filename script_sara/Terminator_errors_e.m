function output = Terminator_errors_e(choice, LVLH, SYN, times_lin, times_cont, settings, nro_T, phi0, n_transf)
...
if choice(1)
   [x_CW_LVLH, ~, ~] = Docking_e(r_LVLH, v_LVLH, tt, tt_2, intervals, nro_T, cr3bp);
    x_CW_syn = rlvlh2rsyn_e(tt, x_CW_LVLH', state_time(tt,nro_T)', cr3bp.mu)';
...
if choice(2)
   [x_SL_LVLH, ~, ~] = Docking_SL(r_LVLH, v_LVLH, T);
    x_SL_syn         = rlvlh2rsyn_e(tt, x_SL_LVLH', state_time(tt,nro_T)', cr3bp.mu)';
