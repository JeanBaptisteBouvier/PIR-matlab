function output = Rendezvous_errors_e(choice, hold_points_dim, TOF_dim, init_cond, orbits, settings, continuation, plot_yes)
...
for i = 1:np-1
    ...
    pop = Terminator_errors_e(choice, LVLH, SYN, times_lin, times_cont, settings, nro_T, phi0, n_transf);
    sol{i} = pop;
end
...
%        plot_3_choice2(choice, choice_help, sol_plot, Lam_plot, Lam_plot_t, r_f_syn, r_f , np, cr3bp, nro_T, nro_C, x0_T, x0_C, i, t_f,t_C)  %Lambert
%    end
% end
