function [Cs] = lvlh2eciRotMat(zeci_t, t, mu)
% Rotation matrix for the change of coordinates: from LVLH to ECI coordinates.
...
%--------------------------------------------------------------------------
% a = dv/dt in ECI is obtained by applying cr3bp_vf_eci_6
%--------------------------------------------------------------------------
zeci_t_dot = cr3bp_vf_eci_6(t, zeci_t, mu);
a = zeci_t_dot(4:6);
